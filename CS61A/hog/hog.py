...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    if opponent_score - player_score == 2 or opponent_score - player_score == 1:
        return True
    return False
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    #keep playing if both scores less than goal
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(s0, s1):
        ...
        if difference > running_high :
            print(str(difference)+ " point(s)! The most yet for Player " + str(who))
...
def make_averaged(original_function, trials_count=1000):
    ...
    notes:
    - original func takes in arbitrary number of arguments
    - 
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    Notes:
    - use make_averaged & roll_dice
    - if rolls tied, return lower number

    - loop through 1 to 10 dice
    - return average
    - max against previous record
        - if it's same as record, not swap it out
    - returns 
    """
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    ...
    record = 1
    while dice_num <= 10:
        average_value = make_averaged(roll_dice, trials_count)(dice_num, dice)
        if average_value > record_value:
            record_value, record = average_value, dice_num
        dice_num += 1
    return record
    # END PROBLEM 9
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score, opponent_score):
        ...
        return bacon_strategy(old_score, opponent_score, cutoff, num_rolls)
    # END PROBLEM 11
