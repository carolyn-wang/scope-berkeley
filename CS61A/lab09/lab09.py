def insert_into_all(item, nested_list):
    ...
    [[0], [0, 1, 2], [0, 3]]
    """
    # return [i[0:0].append(item) for i in nested_list]
...
def inc_subseqs(s):
    ...
    def subseq_helper(s, prev):
        if not s:
            ...
            a = [subseqs(s[i+1:]) for i in s]
            b = [i for i in s]
            return insert_into_all(a, b) 
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n <= 1:
        return 1
    # return 1 + (num_trees(n-1) * 2)
    return sum([num_trees(l) for l in range(n)])
...
def make_advanced_counter_maker():
    ...
    def make_counter():
        ...
        def incr_counter(phrase):
            ...
            elif phrase == 'global-count':
                g_count += 1
                return g_count
            elif phrase == 'global-reset':
                g_count = 0
        return incr_counter
    return make_counter
